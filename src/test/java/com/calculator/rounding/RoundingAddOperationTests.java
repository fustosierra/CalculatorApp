...
public class RoundingAddOperationTests extends BaseTest {

    @Test
    @Stories( value = {@Story(REQUIREMENTS.REQ05) })
    public void roundingAddOperationOnPositiveOne() throws IOException, InterruptedException {
    ...
    @Test
    @Stories( value = {@Story(REQUIREMENTS.REQ05) })
    public void roundingAddOperationOnNegativeOne() throws IOException, InterruptedException {
        String operator = "add";
        String firstOperand = " -1";
        String secondOperand = " 0.0000001";
        String command = operator + firstOperand + secondOperand;
